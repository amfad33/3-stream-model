...
class MultiModalDataset(Dataset):
    def __init__(self, csv_file, classes_csv, images_dir, videos_dir, class_count, parted=False, num_parts=1):
        self.data = []
...
class VideoDataset(Dataset):
    def __init__(self, csv_file, classes_csv, video_dir, class_count, parted=False, num_parts=1):
        self.data = []
    ...
    def __getitem__(self, idx):
        ...
        # Load image
        video_path = os.path.join(self.video_dir, f'part {part + 1}', f'{id}.mp4')
        video = _load_video(video_path)
