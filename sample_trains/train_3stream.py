...
if __name__ == '__main__':
    ...
    # The model
    model = tsm.ThreeStreamModel(num_class, 2048, 10)
    model.to(device)

    # Load model weights if they exist, uncomment this in case
        ...
        if has_eval:
            ...
            with torch.no_grad():
                for batch in dataloader_eval:
                    ...
                    # Forward pass
                    outputs = model(images, videos, audios)
