...
# We have a trained spatial and temporal stream already and want to mix them and train moe
if __name__ == '__main__':
    ...
    # The model
    model = tsm.TwoStreamModelTrainedStreams(3142)
    model.to(device)
    ...
    for epoch in range(num_epochs):
        if has_train:
            ...
            for batch_idx, batch in enumerate(dataloader):
                ...
                optimizer.zero_grad()
                loss.backward()  # Temporarily set retain_graph=True for debugging
