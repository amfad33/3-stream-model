...
import models.audio_stream as aus
...
if __name__ == '__main__':
    ...
    model_save_path = 'G:\\models\\audio_stream_model'
    num_class = 3142
    has_train = False
    has_eval = True
    ...
    # The dataset
    if has_train:
        dataset = dtv.AudioDataset(csv_file, class_csv_file, audios_dir, 3142, parted=False)
        dataloader = DataLoader(dataset, batch_size=8, shuffle=True, num_workers=4)
        # print(len(dataloader))
    if has_eval:
        dataset_eval = dtv.AudioDataset(csv_file_eval, class_csv_file, audios_dir, 3142, parted=False)
        dataloader_eval = DataLoader(dataset_eval, batch_size=8, shuffle=True, num_workers=4)
        # print(len(dataloader))

    # The model
    model = aus.FullyConnectedAudioNet(2048, 3142, 10)
    model.to(device)
